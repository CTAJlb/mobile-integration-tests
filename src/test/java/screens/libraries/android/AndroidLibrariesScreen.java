...
public class AndroidLibrariesScreen extends LibrariesScreen {
    public static final String LIBRARY_BUTTON_BY_LIBRARY_NAME_LOC = "//android.widget.TextView[@text=\"%s\"]";
    public static final String POPUP_MENU_BUTTON_BY_LIBRARY_NAME_LOC = "//android.widget.TextView[@text=\"%s\"]/parent::android.widget.LinearLayout/following-sibling::android.widget.ImageButton";
    ...
    private final IButton btnAddLibrary = getElementFactory().getButton(By.id("accountsMenuActionAccountAdd"), "btnAddLibrary");
    private final IButton btnDelete = getElementFactory().getButton(By.xpath("//android.widget.TextView[@text=\"Delete\"]"), "btnDelete");
    private final IButton btnAcceptDeletion = getElementFactory().getButton(By.id("android:id/button1"), "btnAcceptDeletion");
