...
public class IosNavigationBarPdfScreen extends NavigationBarPdfScreen {
    private final IButton btnToc = getElementFactory().getButton(By.xpath("//XCUIElementTypeNavigationBar/XCUIElementTypeOther[1]//XCUIElementTypeButton[2]"), "Table of content button");
    ...
    private final IButton btnSearch = getElementFactory().getButton(By.xpath("//XCUIElementTypeNavigationBar/XCUIElementTypeOther[2]//XCUIElementTypeButton[2]"), "Search button");
