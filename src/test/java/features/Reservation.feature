Feature: Reservation of book in LYRASIS
  ...
  Scenario: Hold from Book Detail View and Remove a Reserved Book from Book Detail View
    ...
    When Open Catalog
      And Open search modal
      And Search 'unavailable' book of distributor 'Axis 360' and bookType 'AUDIOBOOK' from "LYRASIS Reads" and save as 'bookNameInfo'
      And Switch to 'eBooks' catalog tab
    Then Subcategory screen is present
    When Open EBOOK book with RESERVE action button and 'bookNameInfo' bookName on catalog books screen and save book as 'bookInfo'
    Then Book 'bookInfo' is opened on book details screen
  ...
  @logout @returnBooks @tier1 @exclude_ios
    ...
    When Open Catalog
      ...
      And Open Catalog
      And Open search modal
      And Search 'unavailable' book of distributor 'Bibliotheca' and bookType 'AUDIOBOOK' from "LYRASIS Reads" and save as 'bookNameInfo2'
      ...
      And Search 'unavailable' book of distributor 'Bibliotheca' and bookType 'EBOOK' from "LYRASIS Reads" and save as 'bookNameInfo3'
