Feature: Localization testing in French

  @tier5
  Scenario: French: Tutorial and Welcome screen
    When Close tutorial screen
    Then Welcome screen is opened in French
      And Elements on welcome screen are translated correctly in French

  @tier5
  Scenario: French: Add Library screen
    When Close tutorial screen
      And Close welcome screen in French
    Then Elements on add account screen are translated correctly in French

  @tier5
  Scenario: French: Catalog screen
    When Close tutorial screen
      And Close welcome screen in French
      And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
      And Elements on Catalog screen are translated correctly in French

  @tier5
  Scenario: French: Search screen
    When Close tutorial screen
      And Close welcome screen in French
      And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
    When Open search modal
    Then Elements on Search screen are translated correctly in French

  @tier5
  Scenario: French: Find your library screen
    When Close tutorial screen
      And Close welcome screen in French
      And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
  ...
  @tier5
  Scenario: French: Subcategory screen
    When Close tutorial screen
    And Close welcome screen in French
    And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
  ...
  @tier5
  Scenario: French: Categories in Sort by
    When Close tutorial screen
      And Close welcome screen in French
      And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
  ...
  @tier5
  Scenario: French: Categories in Availability
    When Close tutorial screen
      And Close welcome screen in French
      And Add library "LYRASIS Reads" on Add library screen
    Then Category rows are loaded
  ...
  @tier5:
  Scenario: French: Categories in Collection
    When Close tutorial screen
